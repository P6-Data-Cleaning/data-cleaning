...
def main():
    ...
    # Load data
    print("Loading data cleaned_data_jan_without_cluster.csv...")
    df = dd.read_csv('outputs/csv/cleaned_data_jan_without_cluster.csv', dtype=DTYPES, parse_dates=['# Timestamp'], assume_missing=True)
    ...
    # Save to CSV
    print("Saving to CSV...")
    final_df.to_csv('outputs/csv/cleaned_data_jan_done2.csv', index=False)
