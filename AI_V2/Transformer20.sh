...
#SBATCH --output=Transformer-20-%j.out     # Name of the output file
#SBATCH --error=Transformer-20-%j.err      # Name of the error file
...
singularity exec --nv --bind $(pwd):/workspace containers/ai_container_l4.sif \
    bash -c "cd /workspace && torchrun --standalone --nnodes=1 --nproc_per_node=1 Transformer20.py"
